...
Version  : 0.14.2
Release  : 18
URL      : https://github.com/ocaml/ocamlbuild/archive/0.14.2/ocamlbuild-0.14.2.tar.gz
Source0  : https://github.com/ocaml/ocamlbuild/archive/0.14.2/ocamlbuild-0.14.2.tar.gz
...
%prep
%setup -q -n ocamlbuild-0.14.2
cd %{_builddir}/ocamlbuild-0.14.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672189133
